...
metrics = [ 'mean_word_length', 'doc_length', 'token_length_mean', 'sentence_length_mean', 'syllables_per_token_mean',
'n_tokens','n_unique_tokens', 'n_characters',
            'n_sentences']
...
if __name__ == '__main__':
    ...
    correlation = correlation.loc[:, metrics]
    #.rename(columns={'flesch_kincaid_grade': 'FKGL', 'smog': 'SMOG', 'automated_readability_index': 'ARI', 'CAREC.sc': 'CAREC'})
