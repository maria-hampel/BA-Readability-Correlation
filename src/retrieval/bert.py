...
DATAPATH = './data/retrieval/distilbert/'
...
if __name__ == '__main__':
        ...
        for _, topic in topics.iterrows():
            ...
            for rank, (score, idx) in enumerate(zip(scores, indices)):
                results.append({
                    ...
                    'rank': rank + 1,
                    'score': score.item(),
                    'system': 'sbert' # eigentlich distilbert lol
                })
    ...
    dfallretrieved.to_pickle(path=DATAPATH + 'allretrieved_sbert.pkl.gzip', compression='gzip')
    dftop10.to_pickle(path=DATAPATH + 'top10_sbert.pkl.gzip', compression='gzip')
