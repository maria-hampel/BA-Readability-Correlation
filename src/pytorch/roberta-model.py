...
for score in SCORES:
    dspath = os.path.join(cwd, 'data/torch/datasets/roberta/'+score+'.pkl.gzip')
    ...
    visdir = os.path.join(cwd, 'data/torch/loss-vis-dropout/roberta/')
    os.makedirs(visdir, exist_ok=True)
    plt.savefig(visdir+score+'.pdf')

    modeldir = os.path.join(cwd, 'data/torch/models/roberta' )
    os.makedirs(modeldir, exist_ok=True)
    torch.save(model.state_dict(), os.path.join(cwd, 'data/torch/models/roberta/'+score+'_ann_model.pth'))
